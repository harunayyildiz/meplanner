...
class _HomePageState extends State<HomePage> {
  ...
  Widget buildListView(List<int> keys, Box<TodoModel> todos) {
        ...
        return Dismissible(
          ...
          onDismissed: (DismissDirection drc) async {
            if (drc == DismissDirection.endToStart) {
              ...
              await LocalNotification().cancelNotification(key: key);
            } else if (drc == DismissDirection.startToEnd) {
              //Update
          ...
          //Listview Elemanı Custom Container
          child: TodoWidget(
            todoKey: key,
            title: todo.title,
    ...
    return Container(
      ...
      child: PopupMenuButton<String>(
        ...
        itemBuilder: (BuildContext context) {
          return ["Tümü", "Tamamlanmış", "Tamamlanmamış"].map((optional) {
  ...
  IconButton buildChangeThemeButton() {
    return IconButton(
      onPressed: () {
        ...
        box.put('isLighTheme', !box.get('isLighTheme', defaultValue: false));
  ...
  Container buildNoItem() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Image(
            image: AssetImage('assets/images/noItem2.png'),
          ),
          Padding(
